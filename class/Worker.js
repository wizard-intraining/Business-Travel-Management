...
let workersData = [
    ['w1', [2 * 1000 * 60 * 60 * 24, 23 * 1000 * 60 * 60 * 24], '北京', 350, 1.36 * 1000 * 60 * 60 * 24, -1],
    ['w2', [0 * 1000 * 60 * 60 * 24, 17 * 1000 * 60 * 60 * 24], '北京', 300, 1.71 * 1000 * 60 * 60 * 24, 1 * 1000 * 60 * 60 * 24],
    ['w3', [17 * 1000 * 60 * 60 * 24, 24 * 1000 * 60 * 60 * 24], '北京', 250, 1.5 * 1000 * 60 * 60 * 24, -1],
    ['w4', [0 * 1000 * 60 * 60 * 24, 24 * 1000 * 60 * 60 * 24], '北京', 300, 1.33 * 1000 * 60 * 60 * 24, 4 * 1000 * 60 * 60 * 24],
    ['w5', [0 * 1000 * 60 * 60 * 24, 22 * 1000 * 60 * 60 * 24], '北京', 300, 1.5 * 1000 * 60 * 60 * 24, 4 * 1000 * 60 * 60 * 24],
    ['w6', [1 * 1000 * 60 * 60 * 24, 22 * 1000 * 60 * 60 * 24], '南京', 250, 1.29 * 1000 * 60 * 60 * 24, 1 * 1000 * 60 * 60 * 24],
    ['w7', [2 * 1000 * 60 * 60 * 24, 32 * 1000 * 60 * 60 * 24], '南京', 250, 1.71 * 1000 * 60 * 60 * 24, -1]
]
